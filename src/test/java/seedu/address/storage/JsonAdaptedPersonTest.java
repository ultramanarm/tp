...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_validRemark_returnsPersonWithRemark() throws Exception {
        ...
        assertEquals(new Remark(VALID_REMARK), person.toModelType().getRemark());
    }
    ...
    public void jsonRoundTrip_personWithRemark_preservesRemark() throws Exception {
        Person original = new Person(BENSON.getName(), BENSON.getPhone(), BENSON.getEmail(),
                BENSON.getAddress(), new Remark("Likes \"咖啡\" and tea\nCall after 6pm"), BENSON.getTags());
        ...
        assertEquals(original.getRemark(), restored.toModelType().getRemark());
    }
