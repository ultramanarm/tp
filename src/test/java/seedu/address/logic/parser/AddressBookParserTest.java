...
public class AddressBookParserTest {
    ...
    public void parseCommand_remark() throws Exception {
        RemarkCommand command = (RemarkCommand) parser.parseCommand(
                RemarkCommand.COMMAND_WORD + " " + INDEX_FIRST_PERSON.getOneBased() + " r/Likes coffee");
        assertEquals(new RemarkCommand(INDEX_FIRST_PERSON, new Remark("Likes coffee")), command);
    }

    @Test
    public void parseCommand_remarkWithoutText() throws Exception {
        RemarkCommand command = (RemarkCommand) parser.parseCommand(
